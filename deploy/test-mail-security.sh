...
run_doctor 'rua=mailto:postmaster@example.test; SP = reject; P = NoNe; V = DMARC1' "$NONE_OUTPUT"
...
run_doctor 'SP=none; rua=mailto:postmaster@example.test; P = Quarantine; V=DMARC1' "$QUARANTINE_OUTPUT"
...
run_doctor 'p = REJECT ; v = dmarc1; sp=none' "$REJECT_OUTPUT"
...
printf '%s\n' 'mail-security shell tests: 8 passed'
